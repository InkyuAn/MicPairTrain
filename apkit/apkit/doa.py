...
def angular_distance(a, b):
    # print("Debugging, inside angular_dist... 0, a: ", a, ", b: ", b)
    denom = (_norm(a) * _norm(b))
    # print("Debugging, inside angular_dist... 1")
    if denom < 1e-16:
        return math.pi
    # print("Debugging, inside angular_dist... 2, denom: ", denom)
    sim = np.dot(a, b) / denom
    # print("Debugging, inside angular_dist... 3, sim: ", sim)
    if sim > 1.0:
        return 0.0
    elif sim < -1.0:
        return math.pi
...
def azimuth_distance(a, b):
    # print("Check point, a: ", np.linalg.norm(a[:2]), ", b: ", np.linalg.norm(b[:2]))
    # print("Check point, (_norm(a) * _norm(b)): ", (_norm(a) * _norm(b)))
    # print("Check point, np.dot(a, b): ", np.dot(a, b))
    # print("Check point 2")
